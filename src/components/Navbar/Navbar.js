  ...
  return (
    <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#f1f7f1', boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.1)', padding: '10px', position: 'fixed', width: '99vw', zIndex: '10' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginRight: "50px" }}>
        ...
        <span ><a href='#home' style={{ marginRight: '30px', fontFamily: 'Open Sans, sans-serif', fontWeight: 'bold', color: '#546360', cursor: 'pointer', textDecoration: 'none' }}>
          TRENDING
        </a></span>
        <span ><a href='#search' style={{ marginRight: '30px', fontFamily: 'Open Sans, sans-serif', fontWeight: 'bold', color: '#546360', cursor: 'pointer', textDecoration: 'none' }}>
          SEARCH
        </a></span>
