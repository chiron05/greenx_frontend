      ...
      <div style={{ display: 'flex', alignItems: 'center', marginRight: "50px" }}>
        {(loggedStatus) ?
          <>
            ...
            <Link to='/sellerdashboard'> <button style={{ borderRadius: '5px', border: 'none', backgroundColor: '#2182a1', color: '#2182a1', padding: '10px 20px' }}><div style={{ fontFamily: 'Open Sans, sans-serif', fontWeight: 'bold', color: 'white' }}>DASHBOARD</div></button></Link>
          </> :
